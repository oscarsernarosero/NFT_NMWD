import React from "react";
  ...
  export class OwnershipToSafe extends React.Component{
  ...
  async handleSubmit(event) {
    ...
    const txHash  =  await this.props.ownershipToSafe(to);
  ...
  return (
    <div>
      <h4 className="component-title">Trnasfer The Ownership Of The MarketPlace to the multi-signature wallet: </h4>
